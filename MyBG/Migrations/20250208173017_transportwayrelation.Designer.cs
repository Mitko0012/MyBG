...
namespace MyBG.Migrations
{
    ...
    [Migration("20250208173017_transportwayrelation")]
    partial class transportwayrelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBG.Models.TransportWay", b =>
                {
                    b.HasOne("MyBG.Models.PageModel", "PageModel")
                        .WithMany("TransportWays")
                        .HasForeignKey("PageKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PageModel");
                });
